...
public class AdminBaseCommand extends ChannelSeniorCommand {
    ...
    public AdminBaseCommand(final Hilda hilda, final AdminPlugin plugin) {
        ...
        this.registerSubcommand(new AdminIgnoreCommand(hilda, this, plugin));
        ...
        this.registerSubcommand(new AdminMemoryCommand(hilda, this, plugin));
        this.registerSubcommand(new AdminMusicCommand(hilda, this, plugin));
        this.registerSubcommand(new AdminOverviewCommand(hilda, this));
        this.registerSubcommand(new AdminRecallCommand(hilda, this));
        this.registerSubcommand(new AdminRestartCommand(hilda, this));
        this.registerSubcommand(new AdminRolesCommand(hilda, this));
        this.registerSubcommand(new AdminSayCommand(hilda, this));
        ...
        this.registerSubcommand(new AdminThreadsCommand(hilda, this));
        this.registerSubcommand(new AdminVersionCommand(hilda, this));
        this.registerSubcommand(new AdminVoiceInfoCommand(hilda, this));
        this.registerSubcommand(new AdminVoiceLeaveCommand(hilda, this));
    }
